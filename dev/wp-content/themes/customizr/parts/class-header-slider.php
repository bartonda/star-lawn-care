            ...
            <div class="carousel-inner">
              ...
              <div class="item">
                 <div class="carousel-image">
                  ...
                  <div class="carousel-caption">
                      <h1><?php _e( 'Wills Amazing Lawn Care' , 'customizr' ) ?></h1>
                        <p class="lead"><?php _e( 'View all all of our amazing services' , 'customizr' ) ?></p>
                       <a class="btn btn-large btn-primary" href="<?php echo $admin_link; ?>"><?php _e( 'Take a Look' , 'customizr' ) ?></a>
                    </div>
                </div>
              <div class="item">
                 <div class="carousel-image">
